...
class AddDrinPage extends StatefulWidget {
  const AddDrinPage({Key? key}) : super(key: key);

  @override
  _AddDrinPageState createState() => _AddDrinPageState();
}

class _AddDrinPageState extends State<AddDrinPage> {
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: file == null
                  ...
                  : Container(width: 70, height: 70, child: Image.file(file!))),
          IconButton(
  ...
  Future<void> insertPost(String urlPicture) async {
    ...
    CollectionReference _collectionRef =
        FirebaseFirestore.instance.collection("Drinkss");
    //  print(_firstname.toString());
    return _collectionRef.doc().set(data).then((value) =>
        Navigator.push(context, MaterialPageRoute(builder: (_) => DrinPage())));
  }
        ...
        if (_form.currentState!.validate()) {
          if (file != null) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: const Text('Please choose picture')),
            );
          }
        }
      },
