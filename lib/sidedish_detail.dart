...
class SideDishDetail extends StatefulWidget {
  final String _idi; //if you have multiple values add here
  SideDishDetail(this._idi, {Key? key})
      : super(key: key); //add also..example this.abc,this...

  @override
  _SideDishDetailState createState() => _SideDishDetailState();
}

class _SideDishDetailState extends State<SideDishDetail> {
