...
class AddIceCreaPage extends StatefulWidget {
  const AddIceCreaPage({Key? key}) : super(key: key);

  @override
  _AddIceCreaPageState createState() => _AddIceCreaPageState();
}

class _AddIceCreaPageState extends State<AddIceCreaPage> {
  ...
  Future uploadPost()async{
    ...
    final path = 'IceCream/post$i.jpg';
  ...
  Future<void> insertPost(String urlPicture)async{
    ...
    Map<String, dynamic> data = {
              ...
              CollectionReference _collectionRef = FirebaseFirestore.instance.collection("Ice-Cream");
            //  print(_firstname.toString());
                return _collectionRef.doc()
                .set(data)
                .then((value) =>
                Navigator.push(context, MaterialPageRoute(builder: (_)=> IceCreaPage())));
  }
